...
(1, 'Springa på lunchen', 8, '2020-12-24', '12:00', 'Möts utanför stora ingången');

INSERT INTO ACTIVITY (CATEGORYID, ACTIVITYNAME, MAXMEMBERS, ACTIVITYDATE,ACTIVITYTIME , LOCATION) VALUES
(1, 'Promenera på lunchen', 4, '2020-12-13', '11:00', 'Möts utanför m28a');

INSERT INTO ACTIVITY (CATEGORYID, ACTIVITYNAME, MAXMEMBERS, ACTIVITYDATE,ACTIVITYTIME , LOCATION) VALUES
(2, 'Äta på Nida', 4, '2020-12-12 ', '12:00', 'Möts vid spärrarna');

INSERT INTO ACTIVITY (CATEGORYID, ACTIVITYNAME, MAXMEMBERS, ACTIVITYDATE,ACTIVITYTIME , LOCATION) VALUES
(2, 'Äta ute: Indiskt', 4, '2020-12-11', '11:00', 'Möts vid kajen');
