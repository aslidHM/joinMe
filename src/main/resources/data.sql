...
INSERT INTO ACTIVITY (MEMBERID, CATEGORYID, ACTIVITYNAME, MAXMEMBERS, DATE, TIME, LOCATION) VALUES
((SELECT MEMBERID FROM MEMBER WHERE FULLNAME ='Åsa Lindkvist'), (SELECT CATEGORYID FROM CATEGORYID WHERE CATEGORYID = 1), 'Promenera på lunchen', '4', '2020-12-13', '11:00', 'Möts utanför m28a')

INSERT INTO ACTIVITY (MEMBERID, CATEGORYID, ACTIVITYNAME, MAXMEMBERS, DATE, TIME, LOCATION) VALUES
((SELECT MEMBERID FROM MEMBER WHERE FULLNAME ='Yusri Shakir'), (SELECT CATEGORYID FROM CATEGORYID WHERE CATEGORYID = 2), 'Äta på Nida', '4', '2020-12-12', '12:00', 'Möts vid spärrarna')

INSERT INTO ACTIVITY (MEMBERID, CATEGORYID, ACTIVITYNAME, MAXMEMBERS, DATE, TIME, LOCATION) VALUES
((SELECT MEMBERID FROM MEMBER WHERE FULLNAME ='Robert Stigsson'), (SELECT CATEGORYID FROM CATEGORYID WHERE CATEGORYID = 2), 'Äta ute: Indiskt', '4', '2020-12-11', '11:00', 'Möts vid kajen')
